...
class GovtEmployeesScreen extends StatefulWidget {
  const GovtEmployeesScreen({super.key});

  @override
  State<GovtEmployeesScreen> createState() => _GovtEmployeesScreenState();
}

class _GovtEmployeesScreenState extends State<GovtEmployeesScreen> {
  ...
  List<Map<String, dynamic>> get _allData => [
    {'id': '1', 'name': 'Dipak R. Vankar', 'dept': 'IAS', 'post': 'IAS Officer', 'district': 'Gandhinagar', 'taluka': 'Gandhinagar', 'icon': Icons.account_balance, 'iconColor': Colors.grey.shade800},
    {'id': '2', 'name': 'Riddhi M. Vankar', 'dept': 'Education', 'post': 'Teacher', 'district': 'Ahmedabad', 'taluka': 'Ahmedabad City', 'icon': Icons.menu_book, 'iconColor': Colors.red},
    {'id': '3', 'name': 'Hardik P. Vankar', 'dept': 'Police', 'post': 'Police Inspector', 'district': 'Surat', 'taluka': 'Choryasi', 'icon': Icons.security, 'iconColor': Colors.orange},
    {'id': '4', 'name': 'Kavita B. Vankar', 'dept': 'Health', 'post': 'Staff Nurse', 'district': 'Vadodara', 'taluka': 'Vadodara City', 'icon': Icons.local_hospital, 'iconColor': Colors.redAccent},
    {'id': '5', 'name': 'Jigneshkumar V. Vankar', 'dept': 'Revenue', 'post': 'Talati', 'district': 'Rajkot', 'taluka': 'Jasdan', 'icon': Icons.description, 'iconColor': Colors.green},
    {'id': '6', 'name': 'Rekhaben V. Vankar', 'dept': 'Panchayat', 'post': 'Gram Sevak', 'district': 'Jamnagar', 'taluka': 'Jamnagar City', 'icon': Icons.groups, 'iconColor': Colors.blue.shade800},
    {'id': '7', 'name': 'Manish D. Vankar', 'dept': 'Forest', 'post': 'Forest Guard', 'district': 'Junagadh', 'taluka': 'Junagadh City', 'icon': Icons.park, 'iconColor': Colors.green.shade800},
    {'id': '8', 'name': 'Hetal K. Vankar', 'dept': 'Judiciary', 'post': 'Court Clerk', 'district': 'Bhavnagar', 'taluka': 'Bhavnagar City', 'icon': Icons.gavel, 'iconColor': Colors.indigo},
    {'id': '9', 'name': 'Sanjay L. Vankar', 'dept': 'GEB', 'post': 'Junior Engineer', 'district': 'Mehsana', 'taluka': 'Mehsana City', 'icon': Icons.electric_bolt, 'iconColor': Colors.blue},
    {'id': '10', 'name': 'Devangiben S. Vankar', 'dept': 'Social Justice', 'post': 'Welfare Officer', 'district': 'Kutch', 'taluka': 'Bhuj', 'icon': Icons.people, 'iconColor': Colors.pink},
  ];
